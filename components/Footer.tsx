...
const Footer = () => {
  ...
  <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-2 gap-8 mt-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
        ...
        <div className="col-span-2 pt-6 border-t sm:col-span-1 border-white/10">
          ...
          <nav className="flex flex-col mt-6 space-y-4 text-sm text-gray-300">
            <a className="inline-block" href=""> Spiritual Counselling</a>
          </nav>
        </div>
        ...
        <div className="col-span-2 pt-6 border-t sm:col-span-1 border-white/10">
          ...
          <nav className="flex flex-col mt-6 space-y-4 text-sm text-gray-300">
            <a className="inline-block" href=""> Original Key 6th {'&'} 7th Book of Moses </a>
            <a className="inline-block" href=""> Book of the Prophets </a>
          </nav>
        </div>
    ...
    <div className="mt-3 bg-white p-3 flex justify-center items-center col-span-2 space-x-4 text-gray-500 lg:col-span-5">
    ...
    <div className="pt-8 mt-12 border-t border-white/10">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        <p className="text-xs text-center text-gray-400 lg:text-left">
          Copyright &copy; 2022. AJAHIRA.com. All rights reserved.
        </p>
